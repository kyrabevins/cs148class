...
if (isset($_POST["btnSubmit"])) {
    ...
    $studentId = htmlentities($_POST["txtFirstName"], ENT_QUOTES, "UTF-8");
    $dataRecord[] = $studentId;
    $advisorId = filter_var($_POST["txtEmail"], FILTER_SANITIZE_EMAIL);
    ...
    if ($studentId == "") {
        ...
        $errorMsg[] = "Your student id appears to have extra character.";
        $studentIdERROR = true;
    }
    if ($advisorId == "") {
        $errorMsg[] = "Please enter your advisor id";
        $advisorIdERROR = true;
    } elseif (!verifyEmail($email)) {
        $errorMsg[] = "Your advisor id appears to be incorrect.";
        $advisorIdERROR = true;
    }
    //@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@
    //
